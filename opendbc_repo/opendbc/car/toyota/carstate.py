  ...
  def update(self, can_parsers) -> structs.CarState:
    ...
    if self.CP.enableBsm:
      ...
      if self.CP.flags & ToyotaFlags.SECOC.value:
        ...
        ret.rightBlindspot = (cp.vl["BSM"]["L_ADJACENT"] == 1) or (cp.vl["BSM"]["L_APPROACHING"] == 1) or (cp.vl["BSM"]["L_LIGHT"] > 0)
        ret.leftBlindspot = (cp.vl["BSM"]["R_ADJACENT"] == 1) or (cp.vl["BSM"]["R_APPROACHING"] == 1) or (cp.vl["BSM"]["R_LIGHT"] > 0)
      # --- 新增的盲點偵測邏輯結束 ---
