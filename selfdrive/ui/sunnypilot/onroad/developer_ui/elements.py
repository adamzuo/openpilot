...
class RelDistElement(LeadInfoElement):
  ...
  def update(self, sm, is_metric: bool) -> UiElement:
    ...
    return UiElement(value, "前車距離", self.unit, color)
...
class RelSpeedElement(LeadInfoElement):
  ...
  def update(self, sm, is_metric: bool) -> UiElement:
    ...
    return UiElement(value, "相對速度", self.unit, color)
...
class SteeringAngleElement(LateralControlElement):
  ...
  def update(self, sm, is_metric: bool) -> UiElement:
    ...
    return UiElement(value, "轉向角度", self.unit, color)
...
class DesiredSteeringAngleElement(LateralControlElement):
  ...
  def update(self, sm, is_metric: bool) -> UiElement:
    ...
    return UiElement(value, "期望轉向角", self.unit, color)
...
class ActualLateralAccelElement(LateralControlElement):
  ...
  def update(self, sm, is_metric: bool) -> UiElement:
    ...
    return UiElement(value, "橫向加速", self.unit, color)
...
class DesiredLateralAccelElement(LateralControlElement):
  ...
  def update(self, sm, is_metric: bool) -> UiElement:
    ...
    return UiElement(value, "期望橫向加速", self.unit, color)
...
class LeadSpeedElement(LeadInfoElement):
  ...
  def update(self, sm, is_metric: bool) -> UiElement:
    ...
    return UiElement(value, "參考車速", self.unit, color)
...
class FrictionCoefficientElement:
  ...
  def update(self, sm, is_metric: bool) -> UiElement:
    if ui_state.enforce_torque_control and ui_state.custom_torque_params and ui_state.torque_override_enabled:
      return UiElement(f"{ui_state.torque_override_friction:.3f}", "摩擦係數", self.unit, rl.WHITE)
    ...
    return UiElement(value, "摩擦係數", self.unit, color)
...
class StorageElement:
  ...
  def update(self, sm, is_metric: bool) -> UiElement:
    if not sm.valid['deviceState']:
      return UiElement("-", "剩餘存儲", self.unit, rl.WHITE)
    ...
    return UiElement(value, "剩餘存儲", self.unit, color)
...
class MemoryUsageElement:
  ...
  def update(self, sm, is_metric: bool) -> UiElement:
    if not sm.valid['deviceState']:
      return UiElement("-", "內存佔用", self.unit, rl.WHITE)
    ...
    return UiElement(value, "內存佔用", self.unit, color)
...
class LatAccelFactorElement:
  ...
  def update(self, sm, is_metric: bool) -> UiElement:
    if ui_state.enforce_torque_control and ui_state.custom_torque_params and ui_state.torque_override_enabled:
      return UiElement(f"{ui_state.torque_override_lat_accel_factor:.3f}", "實時扭矩", self.unit, rl.WHITE)

    ltp = sm['liveTorqueParameters']
    value = f"{ltp.latAccelFactorFiltered:.3f}"
    color = rl.Color(0, 255, 0, 200) if ltp.liveValid else rl.WHITE
    return UiElement(value, "實時扭矩", self.unit, color)
...
class CpuTempMaxElement:
  ...
  def update(self, sm, is_metric: bool) -> UiElement:
    if not sm.valid['deviceState']:
      return UiElement("-", "CPU溫度", self.unit, rl.WHITE)
    ...
    return UiElement(value, "CPU溫度", self.unit, color)
